...
const (
	...
	ActionPut string = "put"
)

const (
	EntityStudent    string = "estudiante"
	EntityTeacher    string = "profesor"
	EntityAssigment  string = "asignatura"
	EntityAsignation string = "asignacion"
	EntityCycle      string = "ciclo"
	EntityMatr       string = "matricula"
	EntityRNote      string = "rnota"
...
func ValidateMsg(protocolVersion int, msg Msg) error {
	...
	if msg.Entity != EntityStudent &&
		msg.Entity != EntityTeacher &&
		msg.Entity != EntityAssigment &&
		msg.Entity != EntityAsignation &&
		msg.Entity != EntityCycle &&
		msg.Entity != EntityMatr &&
		msg.Entity != EntityRNote &&
		msg.Entity != EntityStatus {
